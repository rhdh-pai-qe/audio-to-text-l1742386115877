...
3) Access the `workbench` named `audio-to-text-l1742386115877-notebook`.
...
5) In the terminal, run `cd audio-to-text-l1742386115877` to navigate to your sample app's directory.
